...
description: Server-side rendering (SSR), is the ability of an application to contribute by rendering the web-page on the server instead of rendering it in the browser.
position: 3
category: concepts
questions:
